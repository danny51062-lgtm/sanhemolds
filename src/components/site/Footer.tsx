...
export function Footer() {
  return (
    <footer className="section-dark relative pt-20 pb-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-10">
        <div className="grid gap-12 md:grid-cols-[1.4fr_1fr_1fr]">
          ...
          <div>
            <div className="mb-5 text-[10px] uppercase tracking-[0.3em] text-slate-400">Explore</div>
            <ul className="space-y-3">
              {links.map((l) => (
                <li key={l.href}>
                  <a href={l.href} className="text-sm text-slate-200 transition-colors hover:text-primary">
                    {l.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            <div className="mb-5 text-[10px] uppercase tracking-[0.3em] text-slate-400">Contact</div>
            <ul className="space-y-3 text-sm text-slate-200">
              ...
              <li className="text-slate-400">WeChat · wxid_2la3g5ov9c8b22</li>
              <li className="text-slate-400">Wenzhou, Zhejiang, China</li>
            </ul>
          </div>
        </div>
